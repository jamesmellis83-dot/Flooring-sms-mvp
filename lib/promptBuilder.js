 ...
 */
function buildDataBlock({ companyName, job, missingFields, currentEstimate, previousEstimate, askedForCustomerInfo }) {
  const lines = [];
 ...
 */
function buildMessages({ companyName, job, missingFields, currentEstimate, previousEstimate, askedForCustomerInfo, history, userText }) {
  const systemContent = buildSystemPrompt() + "\n\n---\nCURRENT JOB DATA (regenerated fresh every message)\n---\n" +
    buildDataBlock({ companyName, job, missingFields, currentEstimate, previousEstimate, askedForCustomerInfo });
